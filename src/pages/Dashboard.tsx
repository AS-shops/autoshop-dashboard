        ...
        <div className={styles.dashboard}>
            ...
            <div className={styles.recentSection}>
                <div className={styles.sectionHeader}>
                    ...
                    <Link to="/contracts" className={styles.viewAll}>View All</Link>
                </div>
                <div className={styles.recentList}>
                    {recentContracts.length === 0 ? (
                        ...
                        recentContracts.map(contract => (
                            <Link key={contract.id} to={`/contracts/${contract.id}`} className={styles.recentItem}>
                                <div className={styles.recentInfo}>
                                    <h4>{contract.fullName}</h4>
                                    <p>{contract.businessName} - {contract.position}</p>
                                </div>
                                <span className={styles.recentDate}>{formatDate(contract.timestamp)}</span>
                            </Link>
                        ))
                    )}
                </div>
